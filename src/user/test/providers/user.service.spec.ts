...
import { UserEntityHelper } from '../helpers/entites/user.entity.helper';
...
describe('User service', () => {
  ...
  it('Should find a user by id', async () => {
    ...
    userRepository.findOneOrFail.withArgs(user.id).resolves(user);
  ...
  it('Should not delete a user by id because it did not find any user', async () => {
    ...
    userRepository.findOneOrFail.throws(new EntityNotFoundError());
